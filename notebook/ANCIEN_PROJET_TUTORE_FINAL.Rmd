...
acp_serie_C1 = acp_serie_C%>%select(-identifiantCandidat, -genre, -Nationalite, -serie, -mentionAuBac, -redoublementTerminale, -rangEnTerminale, -etablissementOrigine, -FiliereAccueil, -Cycle, -EcoleAccueil,  -DREN, -age, -annee)

acm_serie_C = acp_serie_C%>%select(-BAC_ANGLAIS, -`1ERE_FRANCAIS` , -`2NDE_MATHEMATIQUES`, -TLE_SVT, -BAC_FRANCAIS, -`1ERE_MATHEMATIQUES`, -`2NDE_SVT`, -`TLE_SCIENCES PHYSIQUES`,- BAC_MATHEMATIQUES, -`1ERE_SVT`, -`2NDE_SCIENCES PHYSIQUES`, -`CULTURE GENERALE`, -`BAC_SCIENCES PHYSIQUES`, -`2NDE_ANGLAIS`, -TLE_FRANCAIS, -`CULTURE SCIENTIFIQUE`, -ANGLAIS, -BAC_SVT, -`1ERE_SCIENCES PHYSIQUES`, -`2NDE_FRANCAIS`,-TLE_ANGLAIS, -`1ERE_ANGLAIS`, -TLE_MATHEMATIQUES, -DREN, -annee, -FiliereAccueil, -Cycle, -EcoleAccueil, -Nationalite, -serie, -identifiantCandidat, -dateNaissance, -etablissementOrigine)

acm_serie_C$age = as.factor(acm_serie_C$age)
#colnames(acm_serie_C)
```

```{r}
# typage des variables
acp_serie_C1$admissible = as.factor(acp_serie_C1$admissible)
acp_serie_C1$admis = as.factor(acp_serie_C1$admis)
acp_serie_C1$BAC_ANGLAIS = as.numeric(acp_serie_C1$BAC_ANGLAIS)
acp_serie_C1$BAC_FRANCAIS = as.numeric(acp_serie_C1$BAC_FRANCAIS)
acp_serie_C1$BAC_MATHEMATIQUES = as.numeric(acp_serie_C1$BAC_MATHEMATIQUES)
acp_serie_C1$BAC_SVT = as.numeric(acp_serie_C1$BAC_SVT)
acp_serie_C1$`BAC_SCIENCES PHYSIQUES` = as.numeric(acp_serie_C1$`BAC_SCIENCES PHYSIQUES`)
acp_serie_C1$`1ERE_ANGLAIS` = as.numeric(acp_serie_C1$`1ERE_ANGLAIS`)
acp_serie_C1$`1ERE_FRANCAIS` = as.numeric(acp_serie_C1$`1ERE_FRANCAIS`)
acp_serie_C1$`1ERE_MATHEMATIQUES` = as.numeric(acp_serie_C1$`1ERE_MATHEMATIQUES`)
acp_serie_C1$`1ERE_SVT` = as.numeric(acp_serie_C1$`1ERE_SVT`)
acp_serie_C1$`1ERE_SCIENCES PHYSIQUES` = as.numeric(acp_serie_C1$`1ERE_SCIENCES PHYSIQUES`)
acp_serie_C1$`2NDE_ANGLAIS` = as.numeric(acp_serie_C1$`2NDE_ANGLAIS`)
acp_serie_C1$`2NDE_FRANCAIS` = as.numeric(acp_serie_C1$`2NDE_FRANCAIS`)
acp_serie_C1$`2NDE_MATHEMATIQUES` = as.numeric(acp_serie_C1$`2NDE_MATHEMATIQUES`)
acp_serie_C1$`2NDE_SVT` = as.numeric(acp_serie_C1$`2NDE_SVT`)
acp_serie_C1$`2NDE_SCIENCES PHYSIQUES` = as.numeric(acp_serie_C1$`2NDE_SCIENCES PHYSIQUES`)
acp_serie_C1$TLE_ANGLAIS = as.numeric(acp_serie_C1$TLE_ANGLAIS)
acp_serie_C1$TLE_FRANCAIS = as.numeric(acp_serie_C1$TLE_FRANCAIS)
acp_serie_C1$TLE_MATHEMATIQUES = as.numeric(acp_serie_C1$TLE_MATHEMATIQUES)
acp_serie_C1$TLE_SVT = as.numeric(acp_serie_C1$TLE_SVT)
acp_serie_C1$`TLE_SCIENCES PHYSIQUES` = as.numeric(acp_serie_C1$`TLE_SCIENCES PHYSIQUES`)
```
...
```{r}
acp_serie_C_admissible = acp_serie_C1


#supression des variables
acp_serie_C_admissible = acp_serie_C_admissible%>%select(-admis, -ANGLAIS, -`CULTURE GENERALE`, -`CULTURE SCIENTIFIQUE`, -dateNaissance)
...
res.pca_C = PCA(acp_serie_C_admissible, quali.sup = 1, ncp = 8, graph = F)
fviz_pca_var(res.pca_C, col.var = "cos2", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE)
fviz_pca_var(res.pca_C, col.var = "cos2", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), axes = c(1,3),  repel = TRUE)

#fviz_pca_ind(res.pca_C, col.ind="cos2") + scale_color_gradient2(low="white", mid="blue", high="red", midpoint=0.6, space = "Lab")
#fviz_pca_ind(res.pca_C, col.ind="cos2", axes = c(1,3)) + scale_color_gradient2(low="white", mid="blue", high="red", midpoint=0.6, space = "Lab")

fviz_pca_ind(res.pca_C, label="none", habillage=acp_serie_C_admissible$admissible, addEllipses=TRUE, ellipse.level=0.95, axes = c(1, 2))
fviz_pca_ind(res.pca_C, label="none", habillage=acp_serie_C_admissible$admissible, addEllipses=TRUE, ellipse.level=0.95, axes = c(1, 3))

```

Caracterisation des admis parmi les candidats admissibles
...
```{r}
acp_serie_C_admis = acp_serie_C1

#selection des candidats de la serie admissible
acp_serie_C_admis = acp_serie_C_admis[acp_serie_C_admis$admissible=="1",]

#suppression de la variable admissible
acp_serie_C_admis = acp_serie_C_admis%>%select(-admissible, -dateNaissance)

```


```{r}
res.pca_C_admis = PCA(acp_serie_C_admis, quali.sup = 1, ncp = 8, graph = F)
fviz_pca_var(res.pca_C_admis, col.var = "cos2", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE)
fviz_pca_var(res.pca_C_admis, col.var = "cos2", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), axes = c(1,3),  repel = TRUE)


#fviz_pca_ind(res.pca_C_admis, col.ind="cos2") + scale_color_gradient2(low="white", mid="blue", high="red", midpoint=0.6, space = "Lab")
#fviz_pca_ind(res.pca_C_admis, col.ind="cos2", axes = c(1,3)) + scale_color_gradient2(low="white", mid="blue", high="red", midpoint=0.6, space = "Lab")


fviz_pca_ind(res.pca_C_admis, label="none", habillage=acp_serie_C_admis$admis, addEllipses=TRUE, ellipse.level=0.95, axes = c(1, 2))
fviz_pca_ind(res.pca_C_admis, label="none", habillage=acp_serie_C_admis$admis, addEllipses=TRUE, ellipse.level=0.95, axes = c(1, 3))
#colnames(acp_serie_C_admis)
```
...
res.mca = MCA(acm_serie_C, quali.sup =c(5,6), level.ventil = 0.05, graph = F)
